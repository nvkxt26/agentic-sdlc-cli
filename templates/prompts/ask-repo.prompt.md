...
2. **Answer** from `{{CONTEXT_DIR}}/` plus the actual files. Cite concrete `path:line` references. If the answer isn't grounded in a file you read, say so — never guess. (`{{INSTRUCTIONS_DIR}}/no-assume.instructions.md`)
