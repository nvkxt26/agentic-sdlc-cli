...
2. Detect any **Figma** links in the ticket. For each, use the **figma** skill (`{{SKILLS_DIR}}/figma/`) to fetch node images/metadata and describe the visual changes required.
