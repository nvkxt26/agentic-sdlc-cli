...
The channel that lets agents/skills in **different repos communicate about repo context**. It is paired with the **Repo Q&A** agent: repo-bridge is the deterministic transport (publish/read/mailbox); repo-qa is the intelligence that answers.
...
# on the answering side: the repo-qa agent reads pending questions...
